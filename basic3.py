...
for direction in input: 
	if direction == ">":
		scoordinatea = scoordinatea+1

	if direction =="<":
		scoordinatea = scoordinatea-1

	if direction == "^":
		scoordinateb = scoordinateb+1

	if direction == "v":
		scoordinateb = scoordinateb-1

scoordinate = [scoordinatea, scoordinateb]
...
#with open("basic3.txt") as f:
	#for line in f:

		


	#scoordinate = scoordinate + scoordinate.append((up, right))
	#print scoordinate
	...
	#scoordinate = scoordinate + scoordinate.append((north, south))
